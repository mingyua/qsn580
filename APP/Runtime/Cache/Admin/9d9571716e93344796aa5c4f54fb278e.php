...
<body>
<div class="topsearch">
<span class="topshadow bgadd"><a href="javascript:;"><i class="Hui-iconfont Hui-iconfont-manage"></i>幻灯片列表</a></span>
</div>
<div class="admin">
<div class="pd-20">
...
<table class="table table-border table-bordered table-bg table-hover table-sort">    
    ...
    <tbody>
     <?php if(is_array($slide)): foreach($slide as $key=>$v): ?><tr  class="text-c">
    <td><input type="checkbox" value="" name=""></td>
    <td><img src="__ROOT__/<?php echo ($v["pic"]); ?>" height="60" /></td>
    <td><?php echo ($v["title"]); ?><p>发布时间：<?php echo (date('Y-m-d H:i',$v["time"])); ?></p></td>
    <td><?php echo ($v["cate"]); ?><p>ID: <?php echo ($v["id"]); ?></p></td>
    <td>
	<?php if($v["status"] == 1): ?>显示<?php else: ?><font color="#FF0000">不显示</font><?php endif; ?></td>
          <td class="f-14">
		  <a class="edit"  title="编辑" href="javascript:;" onclick="comm_edit('分类编辑','<?php echo U(GROUP_NAME.'/Slide/edit',array('id'=>$v['id']));?>')"><i class="Hui-iconfont Hui-iconfont-edit"></i>编辑</a> 
		  <a class="del" title="删除" href="javascript:;" onclick="comm_del(this,'<?php echo ($v["id"]); ?>','<?php echo U(GROUP_NAME.'/Slide/del',array(id=>$v['id']));?>')" ><i class="Hui-iconfont Hui-iconfont-del2"></i>删除</a></td>
