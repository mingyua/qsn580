	...
	<div class="row cl ">
		<div id="commleft" class="col-2 f-l ">
				<div class="main_box_inner_left">
					...
					<div class="nav_menu">
						<ul>
							<?php if(is_array($sublist)): foreach($sublist as $key=>$v): ?><li><a href="<?php echo ($site["site_url"]); ?>/<?php echo ($v["url"]); ?>" class='<?php if(($v["id"] == $eqid) or ($v["id"] == $sid)): ?>current<?php else: endif; ?>'><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; ?>
						</ul>
					</div>
				</div>
		...
		<h2 class="current_location_1">当前位置：<a href="<?php echo ($site["site_url"]); ?>">首页</a> &gt; <a href="<?php echo ($cname["url"]); ?>"><?php echo ($cname["name"]); ?></a> &gt; <a href="#"><?php echo ($subname["name"]); ?></a></h2>

			<div  class="content mr-30"><?php echo ($single["contents"]); ?> </div>
