	...
	<div class="row cl ">
		...
		<h2 class="current_location_1">当前位置：<a href="<?php echo ($site["site_url"]); ?>">首页</a> &gt; <a href="<?php echo ($site["site_url"]); ?>/<?php echo ($cname["url"]); ?>"><?php echo ($cname["name"]); ?></a> &gt; <a href="<?php echo ($site["site_url"]); ?>/<?php echo ($subname["url"]); ?>"><?php echo ($subname["name"]); ?></a></h2>
			...
			<div class="content cl mr-30">
					<ul class="newslist">
				<?php if(is_array($lists)): foreach($lists as $key=>$v): ?><li><a href="<?php echo ($site["site_url"]); ?>/show-<?php echo ($cid); ?>-<?php echo ($eqid); ?>-<?php echo ($v["id"]); ?>.html" title="<?php echo ($v["title"]); ?>" alt="<?php echo ($v["title"]); ?>"><?php echo ($v["title"]); ?></a><span class="date"><?php echo (date('Y-m-d',$v["time"])); ?></span></li><?php endforeach; endif; ?>
					</ul>
			</div>
