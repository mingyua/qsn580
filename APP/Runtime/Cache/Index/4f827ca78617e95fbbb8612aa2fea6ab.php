...
<a  target="_blank"><img src="<?php echo ($pic["image"]); ?>" width="100%"  class="box-shadow"></a>
</section>
<section id="content" class="container cl bg-white box-shadow">
	<div class="row cl ">
		...
		<h2 class="current_location_1">当前位置：<a href="<?php echo ($site["site_url"]); ?>">首页</a> &gt; <a href="<?php echo ($cname["url"]); ?>"><?php echo ($cname["name"]); ?></a> &gt; <a href="<?php echo ($subname["url"]); ?>"><?php echo ($subname["name"]); ?></a></h2>
		<div class="col-9 f-l">
			<div class="articleinfor">
			<h1><?php echo ($detail["title"]); ?></h1>
			<div class="info">
			发布日期：<?php echo (date('Y-m-d',$detail["time"])); ?>&nbsp;&nbsp;

			作者：<span id="clicks"><?php echo ($detail["write"]); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;字号：[&nbsp;<a href="javascript:FontZoom('16px','Content')">大</a> <a href="javascript:FontZoom('14px','Content')">中</a>  <a href="javascript:FontZoom('12px','Content')">小</a>]
			</div>
			...
			<div class="updownpage mb-20">
				<ul>
				<li>上一篇：<?php if($upend): echo ($upend); else: ?><a href="show-<?php echo ($cid); ?>-<?php echo ($eqid); ?>-<?php echo ($upid); ?>.html"><?php echo ($up); ?></a><?php endif; ?></li>
				<li>下一篇：<?php if($downend): echo ($downend); else: ?><a href="show-<?php echo ($cid); ?>-<?php echo ($eqid); ?>-<?php echo ($downid); ?>.html"><?php echo ($down); ?></a><?php endif; ?></li>
				</ul>
			</div>
		</div>

			<div id="subright" class="col-3 f-l ">
				<div class="panel panel-default">
					<div class="panel-header">相关阅读</div>
					<div class="panel-body">
						<ul>
							<?php if(is_array($read)): foreach($read as $key=>$v): ?><li><a href="show-<?php echo ($cid); ?>-<?php echo ($v["kinds"]); ?>-<?php echo ($v["id"]); ?>.html"><?php echo ($v["title"]); ?></a></li><?php endforeach; endif; ?>
						</ul>
				...
				<div class="panel panel-default mt-10">
					<div class="panel-header">新闻资讯</div>
					<div class="panel-body">
						<ul>
							<?php if(is_array($news)): foreach($news as $key=>$v): ?><li><a href="show-5-<?php echo ($v["kinds"]); ?>-<?php echo ($v["id"]); ?>.html"><?php echo ($v["title"]); ?></a></li><?php endforeach; endif; ?>
						</ul>
					
					</div>
				</div>

				<div class="panel panel-default mt-10 mb-20">
					<div class="panel-header">疑问解答</div>
					<div class="panel-body">
						<ul>
							<?php if(is_array($question)): foreach($question as $key=>$v): ?><li><a href="show-6-<?php echo ($v["kinds"]); ?>-<?php echo ($v["id"]); ?>.html"><?php echo ($v["title"]); ?></a></li><?php endforeach; endif; ?>
						</ul>
