...
<a target="_blank"><img src="<?php echo ($site["site_url"]); ?>/<?php echo ($pic["image"]); ?>" width="100%"  class="box-shadow"></a>
</section>
<section id="content" class="container cl bg-white box-shadow">
	<div class="row cl ">
		...
		<h2 class="current_location_1">当前位置：<a href="<?php echo ($site["site_url"]); ?>">首页</a> &gt; <a href="<?php echo ($cname["url"]); ?>"><?php echo ($cname["name"]); ?></a> &gt; <a href="<?php echo ($subname["url"]); ?>"><?php echo ($subname["name"]); ?></a></h2>
			...
			<div class="content cl video">
				<?php if(is_array($lists)): foreach($lists as $key=>$v): ?><div class="album-item f-l mr-10 mb-10">
					<a href="<?php echo ($site["site_url"]); ?>/show-<?php echo ($cid); ?>-<?php echo ($eqid); ?>-<?php echo ($v["id"]); ?>.html">
					<div class="album-img">
						<img src="<?php echo ($site["site_url"]); ?>/<?php echo ($v["pic"]); ?>"> 
					</div>
					<div class="album-title"><?php echo ($v["title"]); ?></div>
					<div class="album-bg">
			...
			<div class="pagination cl mb-20"><?php echo ($page); ?></div>
