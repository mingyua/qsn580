		...
		<div class="layui-col-sm12" style="margin-top: 20px;">
			...
			<table class="layui-table">				
				...
				<?php if(is_array($article)): foreach($article as $key=>$v): ?><tr>
					...
					<td class="layui-form">					    
					    <input name="wap" title="显示"  lay-filter="wap" value="<?php echo U('manage/wap',array('id'=>$v['id']));?>"  <?php if($v[wap] == 1): ?>checked<?php endif; ?>  type="checkbox">
					    <input name="hots" title="推荐" lay-filter="hots" value="<?php echo U('manage/hots',array('id'=>$v['id']));?>" <?php if($v[hots] == 1): ?>checked<?php endif; ?>  type="checkbox">					      					    										
					</td>
